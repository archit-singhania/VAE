  ...
  return (
    <div className="ml-studio">
      <header className="admin-heading">
        ...
        <h1>ML insights</h1>
        <p>
          Ten tools that learn from your workspace’s saved content and performance. Every suggestion
      ...
      {!report && (
        <section className="live-panel">
          ...
          <p>
            Some tools need saved captions or media. Predictions need enough comparable performance
            history; unavailable results are clearly marked.
          </p>
        </section>
      )}
      {report && (
        <>
          ...
          <section className="live-panel">
            ...
            <p>
              {report.audit.training_scope}. {report.audit.external_requests} external AI requests.
